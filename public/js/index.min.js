...
function main() {
    ...
    getWeatherData(api).then(function (weatherData) {
        ...
        for (var i = 0; i < howManyReadings; i++) {
            var weatherReading = new weatherReadings(weatherData, i);
            weatherReading.convertDataToDivReady();
            weatherReading.appendDataToDiv(i);
        }
    });
}
var weatherReadings = /** @class */ (function () {
    function weatherReadings(weatherData, switchTimeOfData) {
    ...
    weatherReadings.prototype.convertDataToDivReady = function () {
        this.temp = (parseInt(this.temp) - 273.15).toFixed(0).toString() + 'C';
        this.icon = 'https://openweathermap.org/img/wn/' + this.icon + '@2x.png';
    };
    weatherReadings.prototype.appendDataToDiv = function (i) {
        var tempDiv;
        var dataArray = Object.values(this);
